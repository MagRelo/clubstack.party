    ...
    <div className="">
      {connected ? (
        ...
        <form name="userBankAccount" onSubmit={onSubmit}>
          <legend>Step 1: Connect Your Bank Account</legend>
          <div>
            ...
            {token ? (
              ...
              <div>
                <button
                  style={flashBankButton ? { backgroundColor: '#7329c2' } : {}}
          ...
          <legend>Step 2: Enter Employment Verification Info</legend>
          <fieldset>
