          ...
          <div className="grid grid-2">
            <div>
              <div className="panel">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Soluta quae nesciunt quaerat quam ratione laboriosam
                  necessitatibus, inventore est earum commodi odit facilis totam
                  incidunt ullam possimus ut accusamus corporis non!
                </p>
                ...
                <div className="grid grid-3">
                  ...
                  >
                    <img src={Slack} alt="google" height="20px" />{' '}
                  </div>
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    <img src={ZoomLogo} alt="zoom" height="20px" />
                  </div>
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    <div>
                      <img src={GoogleDriveLogo} alt="google" height="20px" />{' '}
                      <b>Google Drive</b>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <a href="/join" className="btn btn-theme">
            ...
            <div>
              <div className="panel">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Ipsam dicta accusamus molestiae sunt. Sed soluta aut inventore
                  quasi, excepturi explicabo cupiditate nulla officia accusamus?
                  Recusandae doloribus harum distinctio sed natus.
                </p>
                <ul>
                  <li>Live Zoom call each week</li>
                </ul>
